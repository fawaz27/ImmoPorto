 ...
 <header class="p-3 bg-dark text-white">
  ...
  <?php
        if(isset($_POST['btsubmit'])){
            $mot=$_POST['motcle'];
            $requete="SELECT *from logement where titre LIKE BINARY '%$mot%' and status=1 and categorie='demande'";   
            $resultat=mysqli_query($conn, $requete);
               echo " ".mysqli_error($conn);

        }
        else{
            $requete="SELECT *from logement  where categorie='demande'";
            $resultat=mysqli_query($conn, $requete);
           } 
       ...
       ?>
            ...
            <div class="col">
              <td>
                ...
                <img src='<?php echo $ligne['image']?>' alt="Image" height="300" width="400"  ><br>
